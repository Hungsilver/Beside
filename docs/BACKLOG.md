...
| 11/09 | **F12 đợt 2** — D-Day kỳ thi · việc cần làm trong ngày · nhật ký một dòng cuối mỗi chặng học. Đã chốt làm, chia đợt theo yêu cầu chủ dự án | Trung bình | `apps/web/src/screens/StudyScreen.tsx` |
| 11/09 | **F12 đợt 3** — dải thời gian buổi học trong ngày · xếp hạng giữa hai người · tiếng ồn trắng · nghỉ dài sau 4 chặng · cổ vũ thời gian thực qua `/rts` | Trung bình | `apps/api/src/study/study.gateway.ts` |
